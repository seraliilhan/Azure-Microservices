#--------- Flask settings
SERVER_HOST = 'https://hellocellofuncapp.azurewebsites.net/api' # Update this for the appropriate front-end website when up
SERVER_PORT = 5000
...
API_URL = "https://hellocellofuncapp.azurewebsites.net/api"
